"""
PPO Training Script - Exp 3: vs Random opponents
...
def make_opponents():
    try:
        ...
        rb = AgentRuleBased(name="RuleBased_0")
    except ImportError:
        try:
            from ChefsHatGym.agents.agent_rule_based_hard import AgentRuleBasedHard
            rb = AgentRuleBasedHard(name="RuleBased_0")
        except ImportError:
            rb = AgentRandon(name="Random_0")
    return [rb, AgentRandon(name="Random_1"), AgentRandon(name="Random_2")]
